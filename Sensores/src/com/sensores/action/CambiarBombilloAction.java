...
import com.sensores.utilidades.*;
 ...
 * XDoclet definition:
 * 
 * @struts.action path="/cambiarBombillo" name="cambiarBombillo"
 *                input="actualizar.jsp" scope="request" validate="true"
 * @struts.action-forward name="error" path="actualizar.jsp"
 * @struts.action-forward name="exito" path="/actualizar.jsp"
 */
public class CambiarBombilloAction extends Action {
	/*
	 * Generated Methods
	 */
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		System.out.println("Action cambiar bombillo");
		if (ep!=0) {
