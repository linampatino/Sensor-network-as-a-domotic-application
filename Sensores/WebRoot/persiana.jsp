...
<script language="javascript" type="text/javascript"> 
	function cambiarEstado(div,estado,idSensor){
		...
		if(estado=='1'){
			...
			<%session.setAttribute("estado","CERRADA");%>
		...
		if (estado=='2'){
			...
			<%session.setAttribute("estado","ABIERTA");%>
			//Prendiendo el bombillo
		}
		document.location="../Sensores/cambiarPersiana.do";
	}
</script>
<meta http-equiv="refresh" content="9; URL=http://192.168.130.20:8080/Sensores/persiana.jsp">
...
<div id="bodyPan">
  ...
  <div id="topBarSensor">	
		...
		<div id="topSensor1">
		      ...
		      <li class="ventana"><a href="#">Persiana</a></li>
		  	</ul>
		</div>
	</div>
  			...
  			if (estado.equalsIgnoreCase("ABIERTA")) {
  				...
  				out
  						.println("<div id=\""
  								...
  								+ div
  								+ "-on\" src=\"images/"+div+"-on.jpg\" onclick=\"return cambiarEstado(\'"
  								+ div + "\','1',\'" + idSensor
  								+ "\')\"/></div>");
  				out
  						.println("<div id=\""
  								...
  								+ div
  								+ "-off\" src=\"images/"+div+"-off.jpg\" onclick=\"return cambiarEstado(\'"
  								+ div + "\','0',\'" + idSensor
  								+ "\')\"/></div>");
  			}
