...
<meta http-equiv="refresh" content="9; URL=http://192.168.130.20:8080/Sensores/puertas.jsp">
...
<div id="bodyPan">
  ...
  <div id="topBarSensor">	
		<div id="topSensor">
		      ...
		      <li class="puerta"><a href="#">Puertas</a> </li>
  		...
  		for (int i = 0; i < eventos.size(); i++) {
  			...
  			if (estado.equalsIgnoreCase("ABIERTA")) {
  				...
  				out.println("<div id=\""
  								...
  								+ div
  								+ "-on\" src=\"images/"+div+"-on.jpg\""
  								+"/></div>");
  				out.println("<div id=\""
  								+ div
  								+ "\"><img class=\"oculto\" type=\"image\" name=\""
  								+ div
  								+ "-off\" src=\"images/"+div+"-off.jpg\"" 
  								+"/></div>");
  			}
